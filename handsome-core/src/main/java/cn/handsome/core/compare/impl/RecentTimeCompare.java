 ...
 * @date 2023/6/25
 */
public class RecentTimeCompare extends BaseCompare {
    public RecentTimeCompare() {
        super(ConditionOp.RECENT_TIME);
    }
    ...
    public boolean compare(Object value, Object compareTo) {
        ...
        // 时间，最近 N 分钟
        return DateUtil.between(date, DateUtil.date(), DateUnit.MINUTE) <= offset;
    }
}
